...
class flickr extends WP_Widget {
    ...
    function form($instance) {
        ...
        <table class="fullwidth">
            ...
            <tr>
                <td><?php echo esc_html__('Flickr ID:', 'oconnor') ?></td>
                <td><input type='text' class="fullwidth"
                           name='<?php echo esc_attr($this->get_field_name('flickr_widget_id')); ?>'
                           value='<?php echo esc_attr($instance['flickr_widget_id']); ?>'/></td>
            </tr>
            <tr>
                <td><?php echo esc_html__('Number:', 'oconnor') ?></td>
                <td><input type='text' class="fullwidth"
                           name='<?php echo esc_attr($this->get_field_name('flickr_widget_number')); ?>'
                           value='<?php echo esc_attr($instance['flickr_widget_number']); ?>'/></td>
            </tr>
        </table>
        <?php
    }
