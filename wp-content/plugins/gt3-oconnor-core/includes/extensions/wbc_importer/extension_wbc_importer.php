        ...
        function add_importer_section() {
            ...
            if (version_compare($php_version, '5.4' , '<')) {
                $this->parent->sections[] = array(
                    ...
                    'desc'   => '<p><strong style="font-weight:700;">'.(__( "Disclaimer:", "framework" )).'</strong></p><p style="font-weight:700; color:red;">'. apply_filters( 'wbc_importer_description', esc_html__( 'The Demo Importer requires PHP 5.4 or higher. Please contact your hosting provider to update PHP.', 'framework' ) ).'</p></br>',
                ...
                $this->parent->sections[] = array(
                    'id'     => 'wbc_importer_section',
                    'title'  => $wbc_importer_label,
                    'desc'   => '<p><strong style="font-weight:700;">'.(__( "Disclaimer:", "framework" )).'</strong></p><p>'. apply_filters( 'wbc_importer_description', esc_html__( 'All the images available on our demo website are property of their respective owners. The images are used for the demo purposes only.', 'framework' ) ).'</p><p>'. apply_filters( 'wbc_importer_description', esc_html__( 'By clicking "Import Demo" you agree that those images will be downloaded to your website server from our demo website and you take full responsibility for their usage.', 'framework' ) ).'</br>'. apply_filters( 'wbc_importer_description', esc_html__( 'We recommend you to replace the downloaded images with your own ones and then delete them from your server.', 'framework' ) ).'</p></br>',
                    'icon'   => 'el-icon-website',
                    'fields' => array(
                        array(
