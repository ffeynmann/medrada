...
if( !class_exists( 'ReduxFramework_gt3_header_builder' ) ) {
    ...
    class ReduxFramework_gt3_header_builder extends ReduxFramework {
        ...
        public function render() {
            ...
            echo "<div class='gt3_header_builder__setttings has_settings' data-settings-id='header_templates'><div class='gt3_header_builder__setting-icon'><span>".__( 'Select Preset', 'gt3_oconnor_core' )."</span><i class='fa fa-pencil' aria-hidden='true'></i></div></div>";
            echo "<div class='gt3_header_builder__setttings has_settings main_header_cont' data-settings-id='main_header_settings'><div class='gt3_header_builder__setting-icon'><span>".__( 'Main Header Settings', 'gt3_oconnor_core' )."</span><i class='fa fa-pencil' aria-hidden='true'></i></div></div>";            
            ...
            echo "<div class='gt3_header_builder__responsive'>";
                echo "<div class='gt3_header_builder__responsive--desktop gt3_header_builder__responsive_tab active' data-tab-name='desktop'>".__( 'Desktop', 'gt3_oconnor_core' )."</div>";
                echo "<div class='gt3_header_builder__responsive--tablet gt3_header_builder__responsive_tab' data-tab-name='tablet'>".__( 'Tablet', 'gt3_oconnor_core' )."</div>";
                echo "<div class='gt3_header_builder__responsive--mobile gt3_header_builder__responsive_tab' data-tab-name='mobile'>".__( 'Mobile', 'gt3_oconnor_core' )."</div>";
            echo "</div>";
