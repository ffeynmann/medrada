 ...
 * HTML <input> element.
 */
abstract class Input extends \WP_Typography\Vendor\Mundschenk\UI\Abstract_Control
{
    /**
     ...
     * }
     */
    protected function __construct(\WP_Typography\Vendor\Mundschenk\Data_Storage\Options $options, $options_key, $id, array $args)
    {
     ...
     */
    public static function create(\WP_Typography\Vendor\Mundschenk\Data_Storage\Options $options, $options_key, $id, array $args)
    {
