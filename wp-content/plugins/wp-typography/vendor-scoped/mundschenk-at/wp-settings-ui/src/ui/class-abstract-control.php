 ...
 */
abstract class Abstract_Control implements \WP_Typography\Vendor\Mundschenk\UI\Control
{
    /**
     ...
     */
    protected function __construct(\WP_Typography\Vendor\Mundschenk\Data_Storage\Options $options, $options_key, $id, $tab_id, $section, $default, $short = null, $label = null, $help_text = null, $inline_help = \false, array $attributes = [], array $outer_attributes = [], $settings_args = [], $sanitize_callback = null)
    {
     ...
     */
    public function add_grouped_control(\WP_Typography\Vendor\Mundschenk\UI\Control $control)
    {
     ...
     * @param Control $control Any control.
     */
    public function group_with(\WP_Typography\Vendor\Mundschenk\UI\Control $control)
    {
        // Prevent self-references.
        if ($this !== $control) {
