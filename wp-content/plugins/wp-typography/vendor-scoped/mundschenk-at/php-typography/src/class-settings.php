...
class Settings implements \ArrayAccess, \JsonSerializable
{
     ...
     */
    public function __construct($set_defaults = \true, array $mapping = [\PHP_Typography\U::NO_BREAK_NARROW_SPACE => \PHP_Typography\U::NO_BREAK_SPACE, \PHP_Typography\U::APOSTROPHE => \PHP_Typography\U::SINGLE_QUOTE_CLOSE])
    {
        ...
        if (isset($this->unicode_mapping[\PHP_Typography\U::NO_BREAK_NARROW_SPACE])) {
            /* @scrutinizer ignore-deprecated */
            $this->no_break_narrow_space = $this->unicode_mapping[\PHP_Typography\U::NO_BREAK_NARROW_SPACE];
        }
    }
    /**
    ...
    public function remap_character($char, $new_char)
    {
        ...
        if (\PHP_Typography\U::NO_BREAK_NARROW_SPACE === $char) {
            /* @scrutinizer ignore-deprecated */
    ...
    {
        if ($on) {
            $this->remap_character(\PHP_Typography\U::NO_BREAK_NARROW_SPACE, \PHP_Typography\U::NO_BREAK_NARROW_SPACE);
        } else {
            $this->remap_character(\PHP_Typography\U::NO_BREAK_NARROW_SPACE, \PHP_Typography\U::NO_BREAK_SPACE);
        }
    }
    /**
    ...
    public function set_tags_to_ignore($tags = ['code', 'head', 'kbd', 'object', 'option', 'pre', 'samp', 'script', 'noscript', 'noembed', 'select', 'style', 'textarea', 'title', 'var', 'math'])
    {
        ...
        $tags = \array_filter(\array_map('strtolower', \PHP_Typography\Strings::maybe_split_parameters($tags)), 'ctype_alnum');
        $this->data[self::IGNORE_TAGS] = \array_unique(\array_merge($tags, \array_flip(\PHP_Typography\DOM::inappropriate_tags())));
    }
    /**
    ...
    {
        $this->data[self::IGNORE_CLASSES] = \PHP_Typography\Strings::maybe_split_parameters($classes);
    }
    /**
    ...
    {
        $this->data[self::IGNORE_IDS] = \PHP_Typography\Strings::maybe_split_parameters($ids);
    }
    /**
     ...
     */
    public function set_smart_quotes($on = \true)
    {
     ...
     */
    public function set_smart_quotes_primary($style = \PHP_Typography\Settings\Quote_Style::DOUBLE_CURLED)
    {
     ...
     * @throws \DomainException Thrown if $style constant is invalid.
     */
    public function set_smart_quotes_secondary($style = \PHP_Typography\Settings\Quote_Style::SINGLE_CURLED)
    {
    ...
    {
        return $this->get_style($style, \PHP_Typography\Settings\Quotes::class, [\PHP_Typography\Settings\Quote_Style::class, 'get_styled_quotes'], 'quote');
    }
    /**
     ...
     */
    public function set_smart_quotes_exceptions($exceptions = ["'tain't" => \PHP_Typography\U::APOSTROPHE . 'tain' . \PHP_Typography\U::APOSTROPHE . 't', "'twere" => \PHP_Typography\U::APOSTROPHE . 'twere', "'twas" => \PHP_Typography\U::APOSTROPHE . 'twas', "'tis" => \PHP_Typography\U::APOSTROPHE . 'tis', "'til" => \PHP_Typography\U::APOSTROPHE . 'til', "'bout" => \PHP_Typography\U::APOSTROPHE . 'bout', "'nuff" => \PHP_Typography\U::APOSTROPHE . 'nuff', "'round" => \PHP_Typography\U::APOSTROPHE . 'round', "'cause" => \PHP_Typography\U::APOSTROPHE . 'cause', "'splainin" => \PHP_Typography\U::APOSTROPHE . 'splainin', "'em'" => \PHP_Typography\U::APOSTROPHE . 'em'])
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_smart_dashes($on = \true)
    {
     ...
     * @throws \DomainException Thrown if $style constant is invalid.
     */
    public function set_smart_dashes_style($style = \PHP_Typography\Settings\Dash_Style::TRADITIONAL_US)
    {
        $this->dash_style = $this->get_style($style, \PHP_Typography\Settings\Dashes::class, [\PHP_Typography\Settings\Dash_Style::class, 'get_styled_dashes'], 'dash');
    }
    /**
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_smart_ellipses($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_smart_diacritics($on = \true)
    {
    ...
    public function set_diacritic_language($lang = 'en-US')
    {
        ...
        if (\file_exists($language_file_name)) {
            $diacritics_file = \json_decode(\file_get_contents($language_file_name), \true);
    ...
    public function set_diacritic_custom_replacements($custom_replacements = [])
    {
        ...
        $this->data[self::DIACRITIC_CUSTOM_REPLACEMENTS] = self::array_map_assoc(function ($key, $replacement) {
    ...
    private function parse_diacritics_rules(array $diacritics_rules, array &$patterns, array &$replacements)
    {
        foreach ($diacritics_rules as $needle => $replacement) {
            $patterns[] = '/\\b(?<!\\w[' . \PHP_Typography\U::NO_BREAK_SPACE . \PHP_Typography\U::SOFT_HYPHEN . '])' . $needle . '\\b(?![' . \PHP_Typography\U::NO_BREAK_SPACE . \PHP_Typography\U::SOFT_HYPHEN . ']\\w)/u';
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_smart_marks($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_smart_math($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_smart_exponents($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_smart_fractions($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_smart_ordinal_suffix($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_smart_area_units($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_single_character_word_spacing($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_fraction_spacing($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_unit_spacing($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_numbered_abbreviation_spacing($on = \true)
    {
    ...
    {
        $this->data[self::UNITS] = \PHP_Typography\Strings::maybe_split_parameters($units);
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_dash_spacing($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_space_collapse($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_dewidow($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_wrap_hard_hyphens($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_url_wrap($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_email_wrap($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_style_ampersands($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_style_caps($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_style_initial_quotes($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_style_numbers($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_style_hanging_punctuation($on = \true)
    {
    ...
    public function set_initial_quote_tags($tags = ['p', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'blockquote', 'li', 'dd', 'dt'])
    {
        ...
        $this->data[self::INITIAL_QUOTE_TAGS] = \array_change_key_case(\array_flip(
            /** Array. @scrutinizer ignore-type */
            $tags
        ), \CASE_LOWER);
    }
    /**
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_hyphenation($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_hyphenate_headings($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_hyphenate_all_caps($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_hyphenate_title_case($on = \true)
    {
     ...
     * @param bool $on Optional. Default true.
     */
    public function set_hyphenate_compounds($on = \true)
    {
    ...
    {
        $this->data[self::HYPHENATION_CUSTOM_EXCEPTIONS] = \PHP_Typography\Strings::maybe_split_parameters($exceptions);
    }
    /**
