 ...
 * @since 5.0.0
 */
class Style_Caps_Fix extends \PHP_Typography\Fixes\Node_Fixes\Simple_Style_Fix
{
    /*
    ...
    */
	...
	/Sxu';
    const COMBINING_MARKS = '\\-_' . \PHP_Typography\U::HYPHEN . \PHP_Typography\U::SOFT_HYPHEN . \PHP_Typography\U::ZERO_WIDTH_SPACE;
    ...
    {
        parent::__construct(self::REGEX, \PHP_Typography\Settings::STYLE_CAPS, $css_class, $feed_compatible);
    }
}
