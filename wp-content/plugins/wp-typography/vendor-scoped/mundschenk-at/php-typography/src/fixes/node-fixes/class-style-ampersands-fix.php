 ...
 */
class Style_Ampersands_Fix extends \PHP_Typography\Fixes\Node_Fixes\Simple_Style_Fix
{
    /**
    ...
    {
        parent::__construct('/(&)/S', \PHP_Typography\Settings::STYLE_AMPERSANDS, $css_class, $feed_compatible);
    }
}
