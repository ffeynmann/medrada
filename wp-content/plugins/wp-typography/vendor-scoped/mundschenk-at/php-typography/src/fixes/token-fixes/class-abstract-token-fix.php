 ...
 * @since 5.0.0
 */
abstract class Abstract_Token_Fix implements \PHP_Typography\Fixes\Token_Fix
{
    /**
     ...
     */
    public abstract function apply(array $tokens, \PHP_Typography\Settings $settings, $is_title = \false, \DOMText $textnode = null);
    /**
