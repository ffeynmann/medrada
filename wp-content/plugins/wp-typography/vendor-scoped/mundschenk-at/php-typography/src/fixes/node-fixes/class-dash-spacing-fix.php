 ...
 * @since 5.0.0
 */
class Dash_Spacing_Fix extends \PHP_Typography\Fixes\Node_Fixes\Abstract_Node_Fix
{
    // Mandatory UTF-8 modifier.
    const EM_DASH_SPACING = '/
		(?:
			\\s
			(' . \PHP_Typography\U::EM_DASH . ')
			\\s
		)
		|
		(?:
    ...
    {
        if (empty($settings[\PHP_Typography\Settings::DASH_SPACING])) {
            return;
        }
