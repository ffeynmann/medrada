 ...
 * @since 5.0.0
 */
abstract class Simple_Style_Fix extends \PHP_Typography\Fixes\Node_Fixes\Classes_Dependent_Fix
{
    /**
    ...
    protected function apply_internal(\DOMText $textnode, \PHP_Typography\Settings $settings, $is_title = \false)
    {
        ...
        $textnode->data = \preg_replace($this->regex, \PHP_Typography\RE::escape_tags("<span class=\"{$this->css_class}\">\$1</span>"), $textnode->data);
    }
}
