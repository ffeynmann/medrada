 ...
 * @since 5.0.0
 */
class Style_Numbers_Fix extends \PHP_Typography\Fixes\Node_Fixes\Simple_Style_Fix
{
    /**
    ...
    {
        parent::__construct('/([0-9]+)/S', \PHP_Typography\Settings::STYLE_NUMBERS, $css_class, $feed_compatible);
    }
}
