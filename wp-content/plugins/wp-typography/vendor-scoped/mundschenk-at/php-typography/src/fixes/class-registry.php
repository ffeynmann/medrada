...
class Registry
{
    ...
    public function __construct()
    {
        ...
        $this->process_words_fix = new \PHP_Typography\Fixes\Node_Fixes\Process_Words_Fix();
     ...
     */
    public function register_node_fix(\PHP_Typography\Fixes\Node_Fix $fix, $group)
    {
     ...
     */
    public function apply_fixes(\DOMText $textnode, \PHP_Typography\Settings $settings, $is_title, $is_feed)
    {
