 ...
 * @since 5.0.0
 */
class Unit_Spacing_Fix extends \PHP_Typography\Fixes\Node_Fixes\Simple_Regex_Replacement_Fix
{
    const REPLACEMENT = '$1' . \PHP_Typography\U::NO_BREAK_NARROW_SPACE . '$2';
    ...
    {
        parent::__construct(self::REGEX, self::REPLACEMENT, \PHP_Typography\Settings::UNIT_SPACING, $feed_compatible);
    }
    /**
