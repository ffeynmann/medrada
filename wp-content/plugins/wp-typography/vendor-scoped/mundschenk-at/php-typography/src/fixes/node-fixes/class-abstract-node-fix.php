 ...
 * @since 5.0.0
 */
abstract class Abstract_Node_Fix implements \PHP_Typography\Fixes\Node_Fix
{
    /**
     ...
     * @return void
     */
    public abstract function apply(\DOMText $textnode, \PHP_Typography\Settings $settings, $is_title = \false);
    /**
