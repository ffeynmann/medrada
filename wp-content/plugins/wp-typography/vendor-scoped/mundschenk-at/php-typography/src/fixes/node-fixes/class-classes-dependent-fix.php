 ...
 * @since 5.0.0
 */
abstract class Classes_Dependent_Fix extends \PHP_Typography\Fixes\Node_Fixes\Abstract_Node_Fix
{
    /**
    ...
    {
        if (!\PHP_Typography\DOM::has_class($textnode, $this->classes_to_avoid)) {
     ...
     * @return void
     */
    protected abstract function apply_internal(\DOMText $textnode, \PHP_Typography\Settings $settings, $is_title = \false);
}
