			...
			onclick: function(){
				editor.windowManager.open({
					...
					onsubmit: function(e){
						...
						editor.insertContent('<span class="gt3_dropcaps" '+(e.data.text_color != '' ? 'style="font-size: 3em;line-height: 0.97;color:'+e.data.text_color+';' : '')+'">' + selected_text.charAt(0) + '</span>' + selected_text.slice(1));
					}
				});
