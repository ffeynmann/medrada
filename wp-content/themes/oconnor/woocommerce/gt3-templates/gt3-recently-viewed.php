...
if ( $query_products->have_posts() ) {
	echo '<div class="gt3-products-additional-area">';
		echo '<h4>'.esc_html__('Recently Viewed', 'oconnor').'</h4>';
		echo '<a onclick="gt3_clear_recently_products(this)" href="javascript:void(0);" class="clear_recently_products">'.esc_html__('Clear All', 'oconnor').'</a>';
