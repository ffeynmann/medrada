...
$css_classes[] = !empty( $atts['gap'] ) ? 'vc_column-gap-' . $atts['gap'] : '';
...
if ( ! empty( $full_width ) ) {
	...
	} elseif ( 'stretch_row_content_padding_gap' === $full_width ) {
		$wrapper_attributes[] = 'data-vc-stretch-content="true"';
		$css_classes[] = 'vc_row-padding-gap';
...
$custom_class = 'gt3_vc_row_modified ';
$custom_class .= !empty( $box_shadow ) ? 'gt3_custom_shadow ' : '';
$custom_class .= !empty( $z_index ) ? 'gt3_higher_z_index ' : '';
$custom_class .= !empty( $gt3_overflow ) ? 'gt3_overflow-visible ' : '';
$custom_class .= !empty( $z_index ) ? 'gt3_higher_z_index ' : '';
$custom_class .= !empty( $gt3_background ) ? 'gt3_'.esc_attr($gt3_background).' ' : '';

$wrapper_attributes[] = 'class="' . esc_attr($custom_class) . esc_attr( trim( $css_class ) ) . '"';
